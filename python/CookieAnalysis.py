...
if __name__ == "__main__":
    ...
    print("Q2 quantile of outcomes: ", np.quantile(times, .50))
    print("Q1 quantile of outcomes: ", np.quantile(times, .25))
    print("Q3 quantile of outcomes: ", np.quantile(times, .75))

    plt.hist(times, 50, density=True, facecolor='r', alpha=0.75)
